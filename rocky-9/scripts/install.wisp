// Build provision for the rocky-9 template. cloud-init installs the QEMU
// guest agent on first boot; once it answers we block on
...
fn main(lab: Lab) {
    provision(lab).expect("rocky-9 build failed")
}
